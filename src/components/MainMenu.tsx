...
const MainMenu: FC<MainMenuProps> = ({ onStartGame }) => {
  ...
  const handleStartComputer = (): void => {
    onStartGame('computer', difficulty);
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 relative">
      ...
      <div className="relative z-10 w-full max-w-lg space-y-8">
        ...
        <div className="space-y-4">
          ...
          {/* Computer Button or Difficulty Selection */}
          {selectedMode !== 'computer' ? (
            ...
            <div className="glass rounded-2xl p-6 space-y-6 animate-fade-in">
              <h3 className="text-xl font-semibold text-white text-center flex items-center justify-center gap-3">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 px-4 rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 
                             text-white font-semibold transition-all duration-200 
                             hover:from-blue-600 hover:to-cyan-600 hover:scale-[1.02]"
                >
                  Start Game
                </button>
              </div>
